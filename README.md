...
2. **Phone number** — `917 417 9395` is carried over from the previous site.
   Update it in `index.html` (header and footer) and `404.html` if it should differ.
3. **SEO URLs** — replace `YOUR-GITHUB-PAGES-URL` in `robots.txt` and `sitemap.xml`
